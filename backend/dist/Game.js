...
class Game {
    ...
    makeMove(socket, move) {
        ...
        if (this.board.isGameOver()) {
            ...
            (_a = this.participant1) === null || _a === void 0 ? void 0 : _a.emit(JSON.stringify({
                GAME_OVER: messages_1.GAME_OVER,
                payload: {
                    winner: this.board.turn() === "w" ? "black" : "white",
                },
            }));
            (_b = this.participant2) === null || _b === void 0 ? void 0 : _b.emit(JSON.stringify({
                GAME_OVER: messages_1.GAME_OVER,
                payload: {
                    winner: this.board.turn() === "w" ? "black" : "white",
                },
        ...
        if (this.board.moves().length % 2 === 0) {
            ...
            (_c = this.participant2) === null || _c === void 0 ? void 0 : _c.send(JSON.stringify({
            ...
            (_d = this.participant1) === null || _d === void 0 ? void 0 : _d.send(JSON.stringify({
                type: messages_1.MOVE,
                payload: move,
            }));
        }
